...
public class Robotech {
    ...
    public RtFieldDrive rtFieldDrive;
    ...
    public Robotech(HardwareMap parHardwareMap, Telemetry parTelemetry, Gamepad gamepad1, Gamepad gamepad2)
    {
    ...
    {
        //IMU config
        //see ftc website for isntructions
        ...
        rtFieldDrive  = new RtFieldDrive(m_dtLeftBackDcMotor, m_dtRightBackDcMotor,
                m_dtRightFrontDcMotor, m_dtLeftFrontDcMotor, m_telemetry, m_imu, rtLog);
